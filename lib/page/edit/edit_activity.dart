...
class EditActivity extends StatefulWidget {
  final int id;
  final DispayActivity data;
  const EditActivity({Key key, this.id, this.data}) : super(key: key);
...
class _EditActivityState extends State<EditActivity> {
  ...
  void initState() {
    super.initState();
    tempId = widget.id;
    print('id edit :: $tempId');
    todoChoose = widget.data.activityType.capitalizeFirst;
    print('todo :: $todoChoose');
    tujuan.text = widget.data.institution;
    print('tujuan :: ${tujuan.text}');
    DateTime temp = DateTime.parse(widget.data.when);
    print('temp waktu :: $temp');
    waktu.text = DateFormat('dd-MM-yyyy - HH:mm').format(temp);
    tWaktu = DateFormat('yyyy-MM-dd HH:mm:ss').format(temp);
    print('waktu text :: ${waktu.text}');
    print('tWaktu :: $tWaktu');
    wantChoose = widget.data.objective;
    print('want :: $wantChoose');
    desc.text = widget.data.remarks;
    ...
    return InkWell(
      ...
      onTap: () {
        if (todoChoose != null &&
            ...
            wantChoose != null &&
            desc.text != null) {
          print('validation edit sukses');
          print(
              'todoChoose, what /activity type:: ${todoChoose.toLowerCase()}');
      ...
      children: [
        ...
        containerSomething(
          Padding(
            ...
            child: DropdownButtonFormField(
              // validator: (value) =>
              //     value == null ? 'Field tidak boleh kosong' : value,
              dropdownColor: Colors.grey[300],
